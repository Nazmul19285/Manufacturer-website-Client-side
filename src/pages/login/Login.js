            ...
            <div className='mt-12 flex justify-center items-center'>
                <div className='w-80 bg-white drop-shadow-xl p-4 rounded-lg'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {loginError}
                        <input className='btn btn-outline btn-info text-black w-full max-w-xs' type="submit" value="LOGIN" />
                    </form>
                    <p className='text-sm mt-2'>New member? <Link className='text-blue-500' to="/register"> Register here</Link></p>
